...
namespace ImageSplitter.ViewModel
{
    public class MainViewModel : INotifyPropertyChanged, IKeyboardInput
    {
        ...
        public string CurrentMenuUri { get; set; }
        ...
        public MainViewModel()
        {
            ...
            this._rectedImages = new List<Rectangle>();       // GridMode 잘려질 좌표값들 리스트
        ...
        private void DisplayImage_Image_SettingUpdate_Command()
        {
            ...
            if (CurrentMode == ImageSplitMode.GridMode)
                GridModeImageSplit();
            else if (CurrentMode == ImageSplitMode.WhiteSpaceRemoveMode)
